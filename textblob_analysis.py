# -*- coding: utf-8 -*-
"""TextBlob Analysis.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18F_gkQKQSKypHC2L2IV73z3FgBjn917B
"""
...
formatted_dates = [datetime.strftime(d, "%m-%d-%Y") for d in dates]
...
layout = go.Layout(title="Daily Sentiment Distribution - TextBlob",
                   xaxis=dict(tickmode='array', tickvals=dates, ticktext=formatted_dates),
